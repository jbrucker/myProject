 ...
 * and oppackage myhilo;en the template in the editor.
 */
package myhilo;
import java.util.*;
...
public class MyHiLO {
   ...
   static Scanner sc = new Scanner(System.in);
    ...
    static String[] x5 = {"11"};
    static ArrayList<String> X1 = new ArrayList<String>();
    static ArrayList<String> X2 = new ArrayList<String>();
    static ArrayList<String> X3 = new ArrayList<String>();
...
//        System.out.println("456 "+is456(rollA,rollB,rollC));
    ...
    public static int howMuchYouGot(String choose) {
        if (X1.contains(choose)) return 1;
        else if (X2.contains(choose)) return 2;
        else if (X3.contains(choose)) return 3;
        else if (X5.contains(choose)) return 5;
        else return 0;
    }
