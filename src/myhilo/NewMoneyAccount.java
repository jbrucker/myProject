...
public class NewMoneyAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Okbut.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        Okbut.setForeground(new java.awt.Color(255, 0, 51));
        Okbut.setText("OK");
        Okbut.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Okbut.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Okbut.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OkbutActionPerformed(evt);
            }
        });
        getContentPane().add(Okbut, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, 100, 50));

        Bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imageStart/gotmoney.png"))); // NOI18N
