...
in the future we will add more games to this application keeping the concept of High and Low. The new features that we add are similar to HiLow so you have more choices to play on this application.
 ...
 ## Main Features
 - **Login Form** with remembers an account User, Password and Amount of the Money in game
 - **Register Form** to create a new account for playing this game
 - **Game choice** (This Feature is make User to have more choice to play game) *// not implemented yet*
 - **Hilo dice Game** is a page of game that will play by rolling three die
